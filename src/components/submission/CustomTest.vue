      ...
      <div class="card-body px-4">
        <div class="row mb-1 align-items-center">
          ...
          <div class="form-check col" style="text-align:right">
            <input class="form-check-input me-1" type="checkbox" id="sourceCheckbox" value="" style="float:none"
              v-model="sourceByFile">
            <label class="form-check-label" for="sourceCheckbox">Upload file</label>
          </div>
        </div>
        ...
        <div class="row mb-1 mt-3 align-items-center">
          ...
          <div class="form-check col" style="text-align:right">
            <input class="form-check-input me-1" type="checkbox" id="inputCheckbox" value="" style="float:none"
              v-model="inputByFile">
            <label class="form-check-label" for="inputCheckbox">Upload file</label>
          </div>
        </div>
        ...
        <div class="text-center mt-3">
          ...
          <div class="small" style="color:gray" :hidden="!waitHint">OK. Please wait... it may take a long
            period</div>
        </div>
      </div>
    </div>
