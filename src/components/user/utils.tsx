...
export const UserListTable: DataHead<{
  ...
  [key: string | symbol]: any; // other props
    ...
    { name: 'user_id', title: '#ID', columnClass: "text-center ul-col-id" },
    {
      name: 'user_name', title: 'Username', renderer: (user_name, o) => {
        // @ts-ignore
        return <UserName id={o.user_id} name={user_name} rating={o.rating} />
      }
    },
    { name: 'motto', title: 'Motto', columnClass: "text-center" },
    { name: 'rating', title: 'Rating', columnClass: "ul-col-rating text-center" },
  ]
